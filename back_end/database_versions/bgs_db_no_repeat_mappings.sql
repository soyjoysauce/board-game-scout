...
--
-- Host: localhost:3306
-- Generation Time: Oct 04, 2017 at 01:08 AM
...
(1, 'Clark', 'Kent', 'clarkkent@dailyplanet.com', NULL, 'Eurogames', 'Lorem Ipsum asdf'),
(2, 'Bruce', 'Wayne', 'bruce@wayneenterprises.com', 234567, '', ''),
(3, 'Diana', 'Prince', 'd.prince@idontevenknow.com', 123456, 'Eurogames', 'Actually is Wonder Womann'),
(4, 'Lex', 'Luther', 'lex@lexcorp.com', NULL, '', ''),
(5, 'Dude', NULL, 'testmail', 12345678900, 'Eurogames', 'Lorem Ipsum asd');
...
--
ALTER TABLE `events`
  MODIFY `event_ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
--
...
--
ALTER TABLE `users_to_events`
  MODIFY `u_2_e_ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;COMMIT;
