...
--
-- Host: localhost:3306
-- Generation Time: Sep 30, 2017 at 10:09 PM
...
(48, 'Pazzak', '', 'some place', 'Somethingtown', 'CA', '92618', 123.123451, 456.123474, '2017-10-20', '19:30:00'),
(56, 'whatevergame', 'blah blah blah', 'some place', 'Somethingtown', 'CA', '92618', 123.123451, 456.123474, '2017-10-20', '19:30:00'),
(57, 'whatevergame', 'blah blah blah', 'some place', 'Somethingtown', 'CA', '92612', 123.123451, 456.123474, '2017-10-20', '19:30:00');
...
CREATE TABLE `users` (
  ...
  `fav_genre` varchar(25) DEFAULT NULL,
...
(5, 'Dude', NULL, 'testmail', 12345678900, 'Eurogames', 'Lorem Ipsum asdf'),
(6, 'NewGuy', NULL, 'someEmail@newguy.com', 987, '', ''),
(7, 'OtherNewGuy', NULL, 'someOtherEmail@newguy.com', 9876, '', ''),
(8, '', NULL, 'someOtherEmail@newguy.com', 98765, '', '');
...
ALTER TABLE `users_to_events`
  ...
  ADD UNIQUE KEY `event_player` (`event_ID`,`player_ID`);
...
--
ALTER TABLE `events`
  MODIFY `event_ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE `users`
  MODIFY `user_ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `users_to_events`
--
ALTER TABLE `users_to_events`
  MODIFY `u_2_e_ID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;COMMIT;
